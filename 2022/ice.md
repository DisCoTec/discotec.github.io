...
## ICEcreamers
  ...
  * Clément Aubert  (Augusta University, GA, USA) - `aubert (at) math.cnrs.fr`
  * Cinzia Di Giusto (Université Côte d’Azur, CNRS, I3SSophia Antipolis, FR) - `cinzia.di-giusto (AT) unice.fr`
...
* [ICE'21](http://www.discotec.org/2021/ice), June 18, 2020, online event co-located with DisCoTec'21. The post-proceedings were published in EPTCS (vol. ...) and a special issue of JLAMP is in preparation.
